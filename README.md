<div align="center">
  <a href="docs/screenshots/logo.svg">
    <img src="docs/screenshots/logo.svg" width="140" height="140" alt="办公自动化 Agent logo">
  </a>
  <h1>办公自动化 Agent</h1>
  <p>员工用自然语言提需求，Agent 拆解为子任务、按需调用工具执行；高危动作先经员工确认（写盘前可看 diff），执行后反馈结果。带可视化工作台、底部悬浮聊天与外部 MCP 工具消费。</p>

  <!-- badge -->
  <p>
    <img alt="Vue 3" src="https://img.shields.io/badge/Vue-3-42b883?logo=vuedotjs&logoColor=fff">
    <img alt="FastAPI" src="https://img.shields.io/badge/FastAPI-backend-009688?logo=fastapi&logoColor=fff">
    <img alt="SQLite" src="https://img.shields.io/badge/SQLite-WAL-003B57?logo=sqlite&logoColor=fff">
    <img alt="ECharts" src="https://img.shields.io/badge/ECharts-可视化-aa344d?logo=apacheecharts&logoColor=fff">
    <img alt="MCP" src="https://img.shields.io/badge/MCP-fastmcp-4F6D8C">
    <img alt="Tests" src="https://img.shields.io/badge/tests-141%2B-brightgreen">
  </p>
</div>
...
![工作台总览](docs/screenshots/workbench.png)

**底部悬浮聊天**——点右下角悬浮按钮展开，点空白关闭（草稿保留）、可拖拽调大小、历史持久化：

![展开聊天窗](docs/screenshots/chat-dock.png)

**个人中心面板**——点头像展开：QQ 邮箱绑定、权限预留、历史任务：

![个人中心面板](docs/screenshots/user-panel.png)
...
- `tests/` 测试（镜像 backend）
- `scripts/` 一次性脚本
- `docs/` 文档（PRD / MVP / 部署 / 自动化测试 / 面试讲解 / UI 原型 v1–v16）+ `screenshots/` 运行截图
...
<div align="center">
  <img src="docs/screenshots/confirm-diff.png" alt="高危确认 diff 卡片" width="720">
  <p><em>高危写盘前先展示 old → new diff，确认后才落盘</em></p>
</div>
...
<div align="center">
  <img src="docs/screenshots/chart-card.png" alt="出图卡片" width="720">
  <p><em>一句话触发表格聚合，卡片内直接渲染柱状图</em></p>
</div>
...
<div align="center">
  <img src="docs/screenshots/mcp-weather.png" alt="查天气 MCP" width="720">
  <p><em>通过标准 MCP 协议消费外部工具，走同一套审计</em></p>
</div>
